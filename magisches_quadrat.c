...
erzeugen(int neu[80][80], int maxQuadrat, int maxZahl)
{
	...
	for (y = 0; y < maxQuadrat; y++)
	{
		...
		neu[y][x] = zufallszahl(maxZahl);	// Variable "maxZahl" gibt die größtmögliche Zufallszahl an.
	}
}
...
int main()
{
	...
	do
	{
		erzeugen(quadrat, maxQuadrat, maxZahl);						// Quadrat mit Zufallszahlen befüllen
